...
function AddPlayer({ params: query }: PageProps) {
  ...
  async function postData(e: React.FormEvent) {
    ...
    // @ts-ignore
    dataForm.append("license_player", data.license_player);
    // @ts-ignore
        ...
        >
          <div className="wrapper flex flex-row gap-x-5">
            <div className="w-full">
              ...
              <div className="flex flex-col justify-start mt-4 text-sm">
                ...
                >
                  ...
                  <option value="PELATIH_FISIK">PELATIH FISIK</option>
            ...
            <div className="w-full">
              <div className="flex flex-col justify-start mt-4 text-sm  ">
                <label htmlFor="label" className="uppercase opensans font-bold ">
                  foto pelatih <span className="text-[#D00D00] uppercase">maks 2 mb photo file*</span>
                </label>
                <Image
              ...
              <div className="flex flex-col justify-start mt-4 text-sm  ">
                <label htmlFor="label" className="uppercase opensans font-bold ">
                  ijazah pelatih <span className="text-[#D00D00] uppercase">maks 2 mb photo file*</span>
                </label>
                <Image
                  className="w-20 h-30 object-contain"
                  alt="ijazah player"
              ...
              <div className="flex flex-col justify-start mt-4 text-sm  ">
                <label htmlFor="label" className="uppercase opensans font-bold ">
                  akta pelatih <span className="text-[#D00D00] uppercase">maks 2 mb photo file*</span>
                </label>
                <Image
                  className="w-20 h-30 object-contain"
                  alt="license_player"
                  // @ts-ignore
                  src={previewLicense || data.license_player || "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_640.png"}
                  width={400}
                  height={400}
                />
                <input
                  ...
                  onChange={(e) => {
                    // @ts-ignore
                    setPreviewLicense(URL.createObjectURL(e.target.files[0]));
                    handleChange(e);
                  }}
                  className=" block w-full outline-none file:h-full file:bg-[#dddddd] file:border-none file:w-[118px] h-10 mt-2 text-gray-900 border rounded-lg cursor-pointer bg-[#F2F3F7] focus:outline-none  "
                />
