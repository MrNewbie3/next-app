    ...
    <>
      <div className="bg-white w-full  mx-16 rounded-xl px-10 py-10">
        ...
        <div className="grid grid-cols-2  ">
          <div className="bg-[#F2F3F7] max-w-[470px]  rounded-lg flex justify-between px-2 items-center  ">
            ...
            <input id="green-checkbox" type="checkbox" value="" className="w-4 h-4 text-green-800 bg-green-800 border-gray-300 rounded focus:ring-green-500"></input >
          </div>
        </div>
      </div>
    </>
