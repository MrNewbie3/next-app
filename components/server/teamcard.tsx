    ...
    <>
      ...
      <div className=" w-full rounded-lg py-4 ">
        <div className=" flex  justify-between max-lg:flex-col  items-center ">
          <h1 className="capitalize font-bold opensans text-3xl">{data.club_nickname}</h1>
        ...
        <div className="card flex max-lg:flex-col  justify-between mt-8 ">
          <div className="flex w-3/4 gap-4">
            ...
            <div>
              ...
              <h1 className="font-bold capitalize mt-1 text-2xl text-gray-900">{data.club_shortname}</h1>
            </div>
          </div>
          <div className="data_tim w-full uppercase grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-8 gap-6 font-semibold">
            <div>
              ...
              <p className=" capitalize bg-white h-10 w-full  p-2 rounded-lg">{data.club_name}</p>
            </div>
            <div>
              <label className="text-xs font-bold">tanggal berdiri</label>
              <p className=" capitalize bg-white h-10 w-full  p-2 rounded-lg">{data.club_established}(30)</p>
            </div>
            <div>
              <label className="text-xs font-bold">asal club</label>
              <p className=" capitalize bg-white h-10 w-full  p-2 rounded-lg">{data.club_origin}</p>
            </div>
            <div>
