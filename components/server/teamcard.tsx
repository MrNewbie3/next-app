    ...
    <>
      <div className=" w-full rounded-lg py-4 ">
        <div className=" flex  justify-between max-lg:flex-col   items-center ">
          <h1 className="capitalize font-bold opensans text-3xl">Telkom shool soccer club</h1>
        ...
        <div className="card flex max-lg:flex-col  justify-between mt-8 ">
          ...
          <div className="data_tim  uppercase grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-8 gap-6 ">
            <div>
